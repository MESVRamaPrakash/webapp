		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				...
				<div class="card shadow-lg">
					...
					<div class="card-body"
						style="font-family: serif; font-weight: 700;">

						<img alt="Check the connection" src="Images/addstu.png"
							style="height: 13rem; max-width: 18rem; margin-left: 16rem;">

						<p class="fs-3 text-center" style="color: #DC3545">Add
							Students</p>
						...
						<form action="register" method="post">
							...
							<button class="btn btn-outline-danger">Add Student</button>
						</form>
					</div>
